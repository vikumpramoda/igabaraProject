...
export default class AddDinner extends Component {
        ...
        async uploadImage() {
            ...
            if (imgname) {
                ...
                if (this.state.NewUpload) {
                    ...
                    await axios.post('http://localhost:5000/dinner/upload', formData, {
 ...
 onSubmit(e){
     ...
     axios.post('http://localhost:5000/dinner/add',foods)
...
<div><label></label></div>
                                ...
                                <Link to ='dinnerList'><input type="button" value="Food List" class="btn btn-info"/>{' '}</Link>
                                    </div>
