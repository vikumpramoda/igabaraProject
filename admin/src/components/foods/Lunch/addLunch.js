...
let addvalid = false;
let sub = false;
export default class AddLunch extends Component {
        ...
        async uploadImage() {
            ...
            if (imgname) {
                ...
                if (this.state.NewUpload) {
                    ...
                    await axios.post('http://localhost:5000/lunch/upload', formData, {
 ...
 onSubmit(e){
     ...
     axios.post('http://localhost:5000/lunch/add',foods)
